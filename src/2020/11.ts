import { getStableNumberOfOccupiedSeats, getStableNumberOfOccupiedSeatsBasedOnVisibility } from "./seating-system/seating-system";
...
console.log(getStableNumberOfOccupiedSeats(input))

console.log(getStableNumberOfOccupiedSeatsBasedOnVisibility(input))