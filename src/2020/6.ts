import { calculateSumOfCommonAnswersPerGroup, calculateSumOfUniqueAnswersPerGroup } from "./custom-customs/customs";

const input = `gsvdkufnoawjmhp
wvhusojpnikgfadb
vshnpfedgwajkou
aujodhskfvnpgw
okpdnwhsfvjguqa
...
console.log(calculateSumOfUniqueAnswersPerGroup(input));
console.log(calculateSumOfCommonAnswersPerGroup(input));