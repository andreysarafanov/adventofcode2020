import { calculateOuterBagsForShinyGold, calculateTotalBagsInsideShinyGold } from "./handy-haversacks/handy-haversacks";

const input = `light salmon bags contain 5 dark brown bags, 2 dotted coral bags, 5 mirrored turquoise bags.
...
console.log(calculateOuterBagsForShinyGold(input));
console.log(calculateTotalBagsInsideShinyGold(input));