import { calculateValidPasswordsComplex, calculateValidPasswordsSimple } from "./password-processing/process-password";

const input = `eyr:2029 byr:1931 hcl:z cid:128
...
const resultSimple = calculateValidPasswordsSimple(input);
console.log(`resultSimple = ${resultSimple}`);

const resultComplex = calculateValidPasswordsComplex(input);
console.log(`resultComplex = ${resultComplex}`);